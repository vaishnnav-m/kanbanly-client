...
export const TaskComments = ({
  ...
  return (
    <div className="w-full relative flex flex-col">
      {/* Comments List */}
      <div className="flex-1 space-y-6 px-1 pb-4">
        ...
        {comments.length > 0 ? (
          <div className="space-y-6">
            {comments.map((comment) => (
              <div key={comment.commentId} className="group flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0 space-y-1.5">
                  ...
                  {editingCommentId === comment.commentId ? (
                    <div className="space-y-3 pt-1">
                      <div className="border border-border rounded-md overflow-hidden bg-background ring-1 ring-ring/10">
      ...
      <div className="sticky bottom-0 z-10 bg-background pt-4 pb-1 mt-4 -mx-1 px-1 border-t border-border/50 backdrop-blur-sm support-backdrop-blur:bg-background/80">
