...
import { PreferenceCard } from "@/components/organisms/user/PreferenceCard";
import { SecuritySettingsCard } from "@/components/organisms/user/SecuritySettingsCard";

interface UserManagementTemplateProps {
  userData: UserProfileData;
  userPreferences: PreferenceResponse;
